<nav
    class="header-navbar navbar-expand-md navbar navbar-with-menu {{config('laramin.navbar_classes','fixed-top navbar-border')}} {{config('laramin.navbar_color','navbar-light')}} {{config('laramin.navbar_disable',false) ? 'disabled' : ''}}">
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="{{adminRedirectRoute('dashboard')}}"><img
                            class="brand-logo img-fluid" alt="stack admin logo"
                            src="{{asset('laramin/'.config('laramin.default_logo','static/logo.png'))}}"
                            style="width:60px">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    @if (config('laramin.include_mega_menu',false))
                    ...
                    @endif
                    @if (config('laramin.include_maximizer',true))
                    <li class="nav-item d-none d-md-block"><a class="nav-link nav-link-expand" href="#"><i
                                class="ficon feather icon-maximize"></i></a></li>
                    @endif
                    @if (config('laramin.include_search',false))
                ...
                <ul class="nav navbar-nav float-right">
                    @if (config('laramin.include_language_drawer',false))
                    ...
                    @endif
                    @if (config('laramin.include_notification_panel',false))
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#"
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list"><a href="javascript:void(0)">
                                    ...
                                    <div class="media">
                                        <div class="media-left align-self-center"><i
                                                class="feather icon-file icon-bg-circle bg-teal"></i>
                                        </div>
                                        <div class="media-body">
                    ...
                    @endif
                    @if (config('laramin.include_profile_dropdown',true))
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            href="#" data-toggle="dropdown">
                            <div class="avatar avatar-online"><img
                                    src="{{ asset(isset(Auth::user()->profile->profile_pic) ? Auth::user()->profile->thumbnail('profile_pic','small') : 'laramin/static/profile.png')}}"
                                    alt="avatar"><i></i>
                            </div><span class="user-name">{{Auth::user()->name}}</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                href="{{adminEditRoute('profile',Auth::user()->profile->id)}}"><i
