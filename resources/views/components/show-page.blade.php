<div>
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-1">
            <h3 class="content-header-title">Show {{ $name }}</h3>
        </div>
        <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Show {{ $name }}
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="{{config('laramin.global_card',true) ? config('laramin.card_wrapper_classes') : ''}}">
                        <div
                            ...
                            <div
                                class="card-header bg-blue bg-lighten-1 {{config('laramin.global_card',true) ? config('laramin.global_card_header_classes') : ''}}">
                                <h4
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="card-text">
                                            {{ $card_text ?? "Show ".$name." in the system" }} <br>
                                        </p>
