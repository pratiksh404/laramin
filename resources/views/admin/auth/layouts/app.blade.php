...
<head>
    ...
    <meta name="keywords" content="hms. hotel management system">
    <meta name="author" content="Pratik Shrestha">
    <title>{{ $setting->title ?? config('coderz.title','Tech Coderz') }}</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('laramin/assets/app-assets/vendors/css/forms/icheck/icheck.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{asset('laramin/assets/app-assets/vendors/css/forms/icheck/custom.css')}}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('laramin/assets/app-assets/css/pages/login-register.css')}}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu 1-column   blank-page blank-page" data-open="click" data-menu="vertical-menu"
    ...
    <script src="{{asset('laramin/assets/app-assets/vendors/js/forms/icheck/icheck.min.js')}}"></script>
    <script src="{{asset('laramin/assets/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js')}}"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('laramin/assets/app-assets/js/scripts/forms/form-login-register.js')}}"></script>
    <!-- END: Page JS-->
